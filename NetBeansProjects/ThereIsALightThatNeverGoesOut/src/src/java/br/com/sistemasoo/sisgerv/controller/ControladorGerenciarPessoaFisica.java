...
@ManagedBean
@SessionScoped
@Named(value = "controladorGerenciarPessoaFisica")
public class ControladorGerenciarPessoaFisica extends ControladorGerenciar<PessoaFisica>{
   public ControladorGerenciarPessoaFisica(){
